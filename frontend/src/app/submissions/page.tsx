...
type FinalEvaluation = { awarded_total: number; maximum_marks: number };
...
export default function SubmissionsPage() {
  ...
  function beginReview(submission: Submission) {
